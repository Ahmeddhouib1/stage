...
Scenario Outline: Verify user an perform successful, credit sale transaction

"""
   	==================================================================================================================================================================================================
	==================================================================================================================================================================================================
	====================================================================== Test Case : Add Support for Credit Sale transaction (ASI-196) =============================================================
	==================================================================================================================================================================================================
	==================================================================================================================================================================================================
	
    Test Link : https://testlink.evf.us/linkto.php?tprojectPrefix=ARC-SI&item=testcase&id=ARC-SI-111
...
"""
  ...
  Scenario Outline: Verify user an perform successful, credit sale transaction for Maestro
"""
   	==================================================================================================================================================================================================
	==================================================================================================================================================================================================
	====================================================================== Test Case : Add Support for Credit Sale transaction (ASI-196) =============================================================
...
"""
  ...
  """
    ...
    Examples:
      | card_type | pan              | name | exp_date | code | disc_data_t1 | disc_data_t2  | additional_data | mnemonic | brand   | pan_in_response  | pan_in_response2  |
      | Maestro   | 6701234567890123 |      | 2812     | 101  |              | 0000000000000 |                 | MC       | MAESTRO | 6701230000000123 | 2                 |
