...
Feature: Add support of Credit Return transaction (ASI-294)

Scenario Outline: To validate Credit return transactions

 """
   	==================================================================================================================================================================================================
	==================================================================================================================================================================================================
	====================================================================== Test Case : Add Support for Credit return transaction (ASI-294) ======================================================
	==================================================================================================================================================================================================
	==================================================================================================================================================================================================

    Test Link : https://testlink.evf.us/linkto.php?tprojectPrefix=ARC-SI&item=testcase&id=ARC-SI-121
...
"""
  ...
  Scenario Outline: To validate Credit return transactions for Maestro
...
"""
  ...
  """
    ...
    Examples:
      | card_type | pan              | name | exp_date | code | disc_data_t1 | disc_data_t2  | additional_data | mnemonic | brand   | pan_in_response  |
      | Maestro   | 6701234567890123 |      | 2812     | 101  |              | 0000000000000 |                 | MC       | MAESTRO | 6701230000000123 |


  Scenario Outline: To validate Credit return transactions for AMEX ( Approval code should not be received from the host for Amex return transaction : ASI-197 )
