...
Feature: MSR Debit sale  transaction using MASTERCARD Card (TC1)
  ...
  """
	==================================================================================================================================================================================================
	==================================================================================================================================================================================================
	============================================================== Test Case :Add Support for Debit MSR sale transaction  ==================================================================
	==================================================================================================================================================================================================
	==================================================================================================================================================================================================

 Script Document : North_Debit_Test_Script_10-18-2017

|Test Nbr|	CARD                     | Entry Mode| Trans. Amount  | Response    | Response Code|
|1       |	4167 2398 7654 3211	 | msr       | 2500           |  Approval   | 0           |
